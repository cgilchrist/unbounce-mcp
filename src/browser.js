        ...
        if (iframeSrc) {
          ...
          return {
            ...
            note: [
              ...
              'clean responsive HTML, get rid of absolute positioning, etc.), STOP. Before',
              'writing a single line of HTML, call get_classic_builder_modernization_guidelines.',
              'It returns the full workflow and fidelity rules. Skipping it is the #1 cause of',
              'bad replicas — partial rule-following produces redesigns, not replicas, and the',
              'user will reject the result and ask you to redo it. Read the full guidelines.',
              '',
